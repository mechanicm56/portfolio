...
export default function ExperienceShowcaseList(
  ...
  return (
    <div className="mx-auto my-40 max-w-7xl px-6 sm:px-14 md:my-60 md:px-20">
      <h2 className="md:mb-30 mb-16 w-full bg-gradient-to-r from-accent/70 to-accent bg-clip-text text-center text-xl font-bold text-transparent xs:text-2xl sm:text-3xl md:text-5xl">
        {props.title}
      </h2>
